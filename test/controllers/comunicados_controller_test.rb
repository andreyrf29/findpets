...
class ComunicadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create comunicado" do
    assert_difference('Comunicado.count') do
      post comunicados_url, params: { comunicado: { informacoes: @comunicado.informacoes, nome: @comunicado.nome, telefone: @comunicado.telefone } }
    end
  ...
  test "should update comunicado" do
    patch comunicado_url(@comunicado), params: { comunicado: { informacoes: @comunicado.informacoes, nome: @comunicado.nome, telefone: @comunicado.telefone } }
