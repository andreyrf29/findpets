...
class ProprietariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proprietario" do
    assert_difference('Proprietario.count') do
      post proprietarios_url, params: { proprietario: { email: @proprietario.email, nome: @proprietario.nome, senha: @proprietario.senha, telefone: @proprietario.telefone } }
    end
  ...
  test "should update proprietario" do
    patch proprietario_url(@proprietario), params: { proprietario: { email: @proprietario.email, nome: @proprietario.nome, senha: @proprietario.senha, telefone: @proprietario.telefone } }
